...
<head>
    <meta charset="UTF-8">
    <title>Fixed Header Boxed | Admire</title>
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-lg-6 col-sm-7">
                            <ul class="breadcrumb float-right nav_breadcrumb_top_align">
                                ...
                                <li class="breadcrumb-item active">Boxed & Fixed Header Layout</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="inner bg-light lter bg-container">
                    <div class="card">
                        ...
                        <div class="card-block card_block_top_align ">
                            ...
                            <p> Admire Admin Theme is built on Bootstrap v4.0.0-alpha.6 and it is a fully responsive theme...</p>
                    ...
                    <div class="card m-t-35">
                        <div class="card-header bg-white">
                            About Boxed and Fixed Header Layout
                        </div>
                        <div class="card-block card_block_top_align ">
                            <h5> Here Comes Admire  Admin Theme  Description. </h5>
                            <p> Admire Admin Theme is built on Bootstrap v4.0.0-alpha.6 and it is a fully responsive theme...</p>
