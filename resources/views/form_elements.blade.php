                            ...
                            <div class="row">
                                <div class="col-lg-4 input_field_sections">
                                    <div class="form-group has-success">
                                        <h5>Success</h5>
                                        <input type="text" class="form-control form-control-success" id="username">
                                    </div>
                                </div>
                                <div class="col-lg-4 input_field_sections">
                                ...
                                <div class="col-lg-4 input_field_sections">
                                    <div class="form-group has-danger">
                                        <h5>Danger</h5>
                                        <input type="tel" class="form-control form-control-danger" id="phone">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-4 input_field_sections">
                                    ...
                                    <div class="input-group">
                                            <span class="input-group-addon">
                                                <label class="custom-control custom-checkbox mr-0 mb-0 px-2">
                                                    <input type="checkbox" class="custom-control-input form-control">
                                                    <span class="custom-control-indicator mt-0"></span>
                                                </label>
                                            </span>
                                        <input type="text" class="form-control">
                                    </div>
                                    <div class="input-group input_top_align">
                                                <span class="input-group-addon">
                                                     <label class="custom-control custom-radio mr-0 mb-0 px-2">
                    ...
                    <div class="card m-t-35">
                        ...
                        <div class="card-block">
                            <form class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    <div class="col-lg-6 form_input_fields m-t-35">
                                        <h5>Date</h5>
                                        <div class="input-group">
