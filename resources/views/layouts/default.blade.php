        ...
        <div id="left">
            <div class="menu_scroll">
                ...
                <ul id="menu">
                    ...
                    <li  {!! (Request::is('general_components')|| Request::is('cards')|| Request::is('izitoast')|| Request::is('transitions') || Request::is('buttons')|| Request::is('icons')|| Request::is('animations')|| Request::is('sliders')|| Request::is('notifications')|| Request::is('p_notify')|| Request::is('modal')|| Request::is('sortable')|| Request::is('sweet_alert')|| Request::is('cropper')|| Request::is('jstree')|| Request::is('grids_layout') ? 'class="active"' : '') !!}>
                        <a href="javascript:;">
                    ...
                    <li {!! (Request::is('users')|| Request::is('add_user') || Request::is('view_user')|| Request::is('delete_user')? 'class="dropdown_menu active"':"")!!}>
                        <a href="#">
                            <i class="fa fa-user"></i>
