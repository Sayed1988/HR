...
elixir(function(mix) {
    ...
    // jquery.backstretch
    mix.copy(paths.backstretch + 'src/jquery.backstretch.js', destVendors + 'jquery.backstretch/js');

    // LC-switch
    mix.copy(paths.LCswitch + 'lc_switch.css', destVendors + 'LC-switch/css');
    mix.copy(paths.LCswitch + 'lc_switch.min.js', destVendors + 'LC-switch/js');
    ...
    // chart.js
    mix.copy(paths.chartjs + 'dist/Chart.min.js', destVendors + 'chartJs/js');
    ...
    mix.styles(
        [
            ...
            '../../../public/assets/vendors/LC-switch/css/lc_switch.css',
    ...
    mix.scripts(
        [
            ...
            '../../../public/assets/vendors/LC-switch/js/lc_switch.min.js',
    ...
    mix.scripts(
        [
            ...
            '../../../public/assets/js/admire.js',
            '../../../public/assets/vendors/raphael/js/raphael-min.js',
            '../../../public/assets/vendors/d3/js/d3.min.js',
            '../../../public/assets/vendors/c3/js/c3.min.js',
            '../../../public/assets/vendors/toastr/js/toastr.min.js',
            '../../../public/assets/vendors/switchery/js/switchery.min.js',
            '../../../public/assets/vendors/flotchart/js/jquery.flot.js',
            '../../../public/assets/vendors/flotchart/js/jquery.flot.resize.js',
            '../../../public/assets/vendors/flotchart/js/jquery.flot.stack.js',
            '../../../public/assets/vendors/flotchart/js/jquery.flot.time.js',
            '../../../public/assets/vendors/flotspline/js/jquery.flot.spline.min.js',
            '../../../public/assets/vendors/flotchart/js/jquery.flot.categories.js',
            '../../../public/assets/vendors/flotchart/js/jquery.flot.pie.js',
            '../../../public/assets/vendors/flot.tooltip/js/jquery.flot.tooltip.min.js',
            '../../../public/assets/vendors/jquery_newsTicker/js/newsTicker.js',
            '../../../public/assets/vendors/countUp.js/js/countUp.min.js',
            '../../../public/assets/js/pages/new_dashboard.js'


        ], destJs + 'dashboard_components.js');
